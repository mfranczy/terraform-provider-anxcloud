...
func TestAccAnxcloudVLANBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckAnxcloudVLAN(locationID, customerDescription),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourcePath, "location_id", locationID),
					resource.TestCheckResourceAttr(resourcePath, "vm_provsioning", "true"),
			...
			{
				Config: testAccCheckAnxcloudVLAN(locationID, customerDescriptionUpdate),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourcePath, "location_id", locationID),
					resource.TestCheckResourceAttr(resourcePath, "vm_provsioning", "true"),
...
func testAccCheckAnxcloudVLAN(locationID, customerDescription string) string {
	return fmt.Sprintf(`
	...
	`, locationID, customerDescription)
}
